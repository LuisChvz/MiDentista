...
core_patterns = ([
    ...
    path('tratamientos/<int:categoria>/<int:orden>', TratamientoList, name = 'tratamientos'),
    ...
    path('actualizarpacientes/<int:pk>', PacienteUpdate, name = 'updatepaciente'),
    path('dentistas/<int:especialidad>', DentistaList, name = 'dentistas'),
    ...
    path('updatecita/<int:pk>', CitaUpdate, name = 'updatecita'),
